...
{	
	public function new(_options:ButtonOptions) 
	{
		...
		button_renderer.color_hover = new Color(1.1, 1.1, 1.1, 1);
		button_renderer.color_down = new Color(0.9, 0.9, 0.9, 1);
		button_renderer.visual.color = button_renderer.color; 
		button_renderer.visual.texture = Luxe.resources.texture("launcher_assets/image/button_01.png");
